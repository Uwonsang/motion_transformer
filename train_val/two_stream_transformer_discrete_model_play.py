...
from common_pose.camera import *
...
def train(args, train_loader, model, optimizer, ce_criterion, device, 
    ...
    for i, (mask, pos_vec, pose3d_discrete_seq, pose3d_discrete_gt_seq, mfcc_data, beat_data) in enumerate(train_loader):
        print('mask :', mask.shape)
        print('pos_vec :', pos_vec.shape)
        print('pose3d_discrete_seq:', pose3d_discrete_seq.shape)
        print('pose3d_discrete_gt_seq:', pose3d_discrete_gt_seq.shape)
        print('mfcc_data:', mfcc_data.shape)
        print('beat_data:', beat_data.shape)
        ...
        print('input_pose3d_discrete_seq' ,pose3d_discrete_seq.shape)
        print('input_mask', mask.shape)
        print('input_pos_vec', pos_vec.shape)
